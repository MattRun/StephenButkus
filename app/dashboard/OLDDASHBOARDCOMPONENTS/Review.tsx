...
export default function Review() {
  return (
    <div className="w-full bg-gradient-to-r from-[#ececec] to-[#f0f0f0] py-16">
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center gap-16 px-4">
          ...
          >
            <img
              ...
              className="w-[400px] lg:w-[400px] h-auto"
            />
          </a>

          {/* Yelp Logo */}
          <a
            href="https://www.yelp.com/biz/academy-of-environmental-health-and-safety-lawndale"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:scale-110 transition-transform duration-200 ease-in-out"
          >

...
export default function AsbestosResources() {
  ...
  return (
    <div className="flex">
      ...
      {/* Main Content */}
      <div className="flex-1 ml-[20%] py-16 px-6 lg:px-12">
    <div className="container mx-auto">
          {/* Header Section */}
          <div className="bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-4xl lg:text-6xl font-bold text-blue-600">
          Asbestos Resources & Regulations
        </h1>
        <p className="mt-4 text-black">
          ...
          <p className='text-gray-700'>
            ...
            <a
              href="https://www.osha.gov/laws-regs/regulations/standardnumber/1910/1910.1001"
              target="_blank"

  ...
  return (
    <div className="relative py-16 px-8 bg-gray-700 to-black text-white w-full">
      <motion.h2
        ...
        viewport={{ once: true }}
      >
        Why You Should Choose AEHS as Your Training Provider
      </motion.h2>
      ...
      <motion.p
        ...
        custom={0}
      >
        Asbestos courses are crucial for professionals involved in construction, renovation, and environmental safety. The courses provide the necessary certification to handle, sample, and supervise asbestos-related activities safely and in compliance with federal regulations. The courses also enhance your knowledge of risk management, project oversight, and safety procedures, making you a valuable asset in the asbestos abatement and management field.
      </motion.p>

    ...
    <div className="min-h-screen flex bg-gradient-to-r from-gray-700 to-gray-900 text-white">
      ...
      <main className="flex-grow p-8">
        <div className="bg-white text-gray-900 p-8 rounded-lg shadow-lg">
          <h1 className="text-3xl font-bold mb-6">Trabajador de asbesto AHERA (actualización) - Curso de 8 horas</h1>
          <p className="text-lg mb-4">
          El curso de actualización para trabajadores de asbesto de AHERA es una capacitación de 8 horas diseñada para personas que 
          previamente completaron el curso inicial de trabajadores de asbesto de AHERA y necesitan renovar su certificación. Este 
          curso refuerza el conocimiento crítico y actualiza a los participantes sobre las regulaciones actuales, prácticas de 
          seguridad y técnicas relacionadas con el manejo y reducción del asbesto.
          </p>
          <h2 className="text-2xl font-semibold mb-4">Los temas clave incluyen:</h2>
          <ul className="list-disc list-inside mb-6">
            <li>Revisión de las propiedades del amianto y los riesgos para la salud.</li>
            <li>Actualizaciones sobre regulaciones de asbesto y requisitos de cumplimiento</li>
            <li>Mejores prácticas para identificar y gestionar materiales que contienen asbesto (ACM)</li>
            <li>Prácticas laborales seguras avanzadas y uso de equipos de protección personal (EPP)</li>
            <li>Protocolos de respuesta a emergencias y gestión de incidentes.</li>
          </ul>
          <p className="text-lg mb-4">
          Los participantes participarán en debates interactivos y ejercicios prácticos que mejorarán su comprensión del manejo 
          seguro del asbesto. Este curso de actualización es esencial para mantener el cumplimiento y garantizar la seguridad de los 
          trabajadores en entornos donde el asbesto puede estar presente.
          </p>
          {/* Sign Up Button */}
          <button

...
//     nextSession: 'October 15 - October 18, 2024',
...
//           <h1 className="text-3xl font-bold mb-6">NIOSH 582 Equivalency Course (32 Contact Hours)</h1>
//           <p className="text-lg mb-4">
//             This comprehensive course provides participants with an in-depth understanding of the principles and practices
//             of industrial hygiene related to air sampling and analytical techniques. Designed for those seeking to meet the
//             equivalency requirements of the NIOSH 582 course, this program covers essential topics including:
//           </p>
//           <h2 className="text-2xl font-semibold mb-4">Key Topics Include:</h2>
//           <ul className="list-disc list-inside mb-6">
//             <li>Fundamentals of air sampling methodologies</li>
//             <li>Quantitative analysis of airborne contaminants</li>
//             <li>Sampling equipment selection and calibration</li>
//             <li>Data interpretation and reporting</li>
//             <li>Practical applications and case studies</li>
//           </ul>
//           <p className="text-lg mb-4">
//             Participants will engage in hands-on activities, including real-world sampling scenarios, to reinforce theoretical concepts.
//             By the end of the course, attendees will be equipped with the skills necessary to effectively assess and manage occupational
//             exposure to hazardous substances, ensuring a safer workplace environment. The course is ideal for occupational health and safety
//             professionals, industrial hygienists, environmental health practitioners, and anyone involved in workplace air quality assessments.
//           </p>
//           {/* Sign Up Button */}
//           <button
...
//           <p className="mb-2">
//             <strong>Location:</strong> {courseDetails.location}
//           </p>
//           <p className="mb-2">
//             <strong>Next Session:</strong> {courseDetails.nextSession}
//           </p>
//           <p>
//             <strong>Time:</strong> {courseDetails.time}
//           </p>
//         </div>
...
//       {showPopup && (
//         <CourseRegistration
//           courseDetails={courseDetails} // Pass course details to the registration component
//           onClose={() => setShowPopup(false)} // Handle close popup
//         />
//       )}
//     </div>
//   );
...
export default function Course1Page() {
  ...
  // Define course details for the current course
  const courseDetails = {
    name: 'NIOSH 582 Equivalency Course (32 Contact Hours)',
    price: '$500',
    description:
      'This comprehensive course provides participants with an in-depth understanding of the principles and practices of industrial hygiene related to air sampling and analytical techniques.',
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-r from-gray-700 to-gray-900 text-white">
      ...
      {showPopup && (
        <CourseRegistration
          courseDetails={courseDetails} // This is specific to each course page
          onClose={() => setShowPopup(false)} // Closes the popup
        />
      )}
    </AnimatePresence>

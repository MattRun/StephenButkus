...
export default function Course1Page() {
  ...
  const courseDetails = {
    name: 'CDPH Continuing Education General - XXX Contact Hours COMING SOON',
    price: '$500',
    description:
    ...
    <div className="min-h-screen flex bg-gradient-to-r from-gray-700 to-gray-900 text-white">
      ...
      <main className="flex-grow p-8">
        <div className="bg-white text-gray-900 p-8 rounded-lg shadow-lg">
          <h1 className="text-3xl font-bold mb-6">CDPH Continuing Education General - XXX Contact Hours COMING SOON</h1>

...
const WorkerSafetyOpportunities = () => {
  ...
  return (
    <div className="relative py-16 px-8 bg-gray-700 to-black text-white w-full">
      <motion.h2
        ...
        viewport={{ once: true }}
      >
        Why You Should Choose AEHS for Worker Safety Training
      </motion.h2>
      ...
      <motion.p
        ...
        custom={0}
      >
        Worker safety courses are essential for professionals in industrial, construction, and environmental roles. These courses ensure compliance with OSHA regulations and enhance workplace safety through practical knowledge and hands-on training. By completing these programs, you'll gain the skills necessary to safeguard yourself and your coworkers in high-risk environments.
      </motion.p>
...
export default WorkerSafetyOpportunities;

...
// const CourseRegistration = ({ courseDetails = {}, onClose }: { courseDetails?: any; onClose?: () => void }) => {
...
//   const [, setShowPopup] = useState(true); // Always show popup by default
...
//       setFormData({ firstName: '', lastName: '', phone: '', email: '', course: '', date: '', additionalInfo: '' });
